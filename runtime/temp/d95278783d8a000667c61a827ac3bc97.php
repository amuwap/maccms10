<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"/workspace/application/admin/view/system/configcollect.html";i:1775560112;s:50:"/workspace/application/admin/view/public/head.html";i:1775560112;s:50:"/workspace/application/admin/view/public/foot.html";i:1775560112;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-tab" lay-filter="tb1">
            <ul class="layui-tab-title">
                <li class="layui-this" lay-id="configcollect_1">视频采集设置</li>
                <li lay-id="configcollect_2">文章采集设置</li>
                <li lay-id="configcollect_3">明星采集设置</li>
                <li lay-id="configcollect_4">角色采集设置</li>
                <li lay-id="configcollect_5">采集词库设置</li>
            </ul>
            ...
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">名称同义词替换：</label>
                    <div class="layui-input-inline">
                        <input type="radio" name="collect[vod][psename]" value="0" title="关闭" <?php if($config['collect']['vod']['psename'] != 1): ?>checked <?php endif; ?>>
                        <input type="radio" name="collect[vod][psename]" value="1" title="开启" <?php if($config['collect']['vod']['psename'] == 1): ?>checked <?php endif; ?>>
                    </div>
                    <div class="layui-form-mid layui-word-aux">自动转换名称同义词，降低重复率。例如:第1季=第一季;</div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="radio" name="collect[vod][urlrole]" value="0" title="替换" <?php if($config['collect']['vod']['urlrole'] != 1): ?>checked <?php endif; ?>>
                        <input type="radio" name="collect[vod][urlrole]" value="1" title="合并" <?php if($config['collect']['vod']['urlrole'] == 1): ?>checked <?php endif; ?>>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="checkbox" lay-skin="primary" name="collect[vod][uprule][]" value="w" title="分集剧情" <?php if(strpos($config['collect']['vod']['uprule'],'w') !==false): ?>checked <?php endif; ?>>
                    </div>
                </div>
            ...
            <div class="layui-tab-item">
                <blockquote class="layui-elem-quote layui-quote-nm">
                    同义词库：每行一个，不要有空行，格式：要替换=替换后，不允许出现#号。<br>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">视频名称同义库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">视频介绍同义词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">视频介绍随机词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">文章介绍同义词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">文章介绍随机词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">明星介绍同义词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">明星介绍随机词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">角色介绍同义词库：</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">角色介绍随机词库：</label>
                    <div class="layui-input-block">
